...
#include "LevelChatTextWidget.h"



void ULevelChatTextWidget::NativeConstruct()
{
	Super::NativeConstruct();
	
	//UPanelWidget* RootWidget = Cast<UPanelWidget>(GetRootWidget());

	//TestTextBlock->OnClicked.AddDynamic(this, &MyUserWidget::OnButtonClicked); // Example click binding.

}

TSharedRef<SWidget> ULevelChatTextWidget::RebuildWidget()
{
	UPanelWidget* RootWidget = Cast<UPanelWidget>(GetRootWidget());
