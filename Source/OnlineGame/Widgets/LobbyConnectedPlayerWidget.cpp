...
#include "LobbyConnectedPlayerWidget.h"




void ULobbyConnectedPlayerWidget::NativeConstruct()
{
	Super::NativeConstruct();
}

TSharedRef<SWidget> ULobbyConnectedPlayerWidget::RebuildWidget()
{
...
void ULobbyConnectedPlayerWidget::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
